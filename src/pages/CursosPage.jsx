...
import Pagination from '../components/ui/Pagination'; // <--- IMPORTAR PAGINACIÓN
...
export default function CursosPage() {
    ...
    const itemsPerPage = 6; // Mostrar 6 cursos por página
        ...
        <div className="container mx-auto pt-32 pb-20 px-6 animate-fade-in min-h-screen relative">
            ...
            {loading ? (
                ...
                <div className="text-center py-20">
                    ...
                    <p className="text-slate-500 text-xl">No se encontraron cursos que coincidan con tu búsqueda.</p>
                </div>
            ) : (
                <>
